    ...
    <div class="float-left col-md-6">
            ...
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    ...
                    <input type="text" class="form-control" name="nama" id="nama" value="{{ $biodata->nama }}" @required(true)> 
                </div>
                <div class="col p-2">
                    <label>NRP/NIP <code>*</code></label>
                    <input type="text" class="form-control" name="nrp_nip" id="nrp_nip" value="{{ $biodata->nrp_nip }}" @required(true)> 
                </div></div>
            
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    <label>Tempat,</label>
                    <input type="text" class="form-control" name="tmp_lahir" id="tmp_lahir" value="{{ $biodata->getVal($biodata->tmp_lahir) }}"> 
                </div>
                <div class="col p-2">
                    <label>Tanggal Lahir</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="tgl_lahir" id="mdate_lahir" value="@isset ($biodata->tgl_lahir){{ Carbon\Carbon::createFromFormat('Y-m-d', $biodata->tgl_lahir)->format(format:'d-m-Y') }} @endisset">
                ...
                <div class="col p-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly text-right" name="usia" id="usia" value="{{ $biodata->getMasa($biodata->usia) }}" @readonly(true)>
                        <div class="input-group-append">
            ...
            <div class="form-group d-flex m-0">
                ...
                <div class="col p-2">
                    ...
                    <select class="form-control" name="kelamin_id" id="kelamin">
                        ...
                        <option value="{{ $opt->id }}" @if($biodata->kelamin_id==$opt->id) @selected(true) @else @selected(false) @endif>{{ ucfirst($opt->nama) }}</option>
                        @endforeach
                    </select>
                </div></div>
            <div class="form-group d-flex m-0">
                ...
                <div class="col p-2">
                    ...
                    <input type="text" class="form-control" name="nama_pasangan" id="nama_pasangan" value="{{ $biodata->getVal($biodata->nama_pasangan) }}"> 
                </div></div>
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    <label>Selular</label>
                    <input type="text" class="form-control" name="phone1" id="phone" value="{{ $biodata->getVal($biodata->phone1) }}">
                </div>
                <div class="col p-2">
                    <label>Email</label>
                    <input type="email" class="form-control" name="email" id="email" value="{{ $biodata->getVal($biodata->email) }}"> 
                </div></div>
            <div class="form-group p-2 m-0">
                {{-- <label></label> --}}
                <textarea class="form-control" rows="1" name="alamat_sekarang" placeholder="Alamat Sekarang" id="alamat_sekarang">{{ $biodata->getVal($biodata->alamat_sekarang) }}</textarea></div>
            <div class="form-group p-2 m-0">
                {{-- <label></label> --}}
                <textarea class="form-control" rows="1" name="alamat_pensiun" placeholder="Alamat Pensiun" id="alamat_pensiun">{{ $biodata->getVal($biodata->alamat_pensiun) }}</textarea></div>

            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    <label>NIK</label>
                    <input type="text" class="form-control" name="nik" id="nik" value="{{ $biodata->getVal($biodata->nik) }}">
                </div>
                <div class="col p-2">
                    <label>NO BPJS</label>
                    <input type="text" class="form-control" name="bpjs" id="bpjs" value="{{ $biodata->getVal($biodata->bpjs) }}">
                </div></div>
            
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    <label>NO KTA</label>
                    <input type="text" class="form-control" name="kta" id="kta" value="{{ $biodata->getVal($biodata->kta) }}"> 
                </div>
                <div class="col p-2">
                    <label>NPWP</label>
                    <input type="text" class="form-control" name="npwp" id="npwp" value="{{ $biodata->getVal($biodata->npwp) }}"> 
                </div></div>
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    <label>Jabatan Terakhir</label>
                    <input type="text" class="form-control" name="jabatan" id="jabatan" value="{{ $biodata->getVal($biodata->jabatan) }}"> 
                </div></div>
    </div>
    <div class="float-left col-md-6 border-left">
            ...
            <div class="form-group d-flex m-0">
                <div class="col p-2">
                    ...
                    <select class="form-control" name="pangkat_id" id="pangkat">
                        ...
                        <option value="{{ $opt->id }}" @if($biodata->pangkat_id==$opt->id) @selected(true) @else @selected(false) @endif>{{ ucfirst($opt->nama) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col p-2">
                    ...
                    <select class="form-control" name="korps_id" id="korps">
                        ...
                        <option value="{{ $opt->id }}" @if($biodata->korps_id==$opt->id) @selected(true) @else @selected(false) @endif>{{ ucfirst($opt->nama) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col p-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="tmt_pangkat" id="mdate_pangkat" value="@isset ($biodata->tgl_lahir){{ Carbon\Carbon::createFromFormat('Y-m-d', $biodata->tgl_lahir)->format(format:'d-m-Y') }} @endisset">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <span class="mdi mdi-calendar"></span>
                            </span>
            ...
            <div class="form-group d-flex m-0">
                <div class="col-8 p-2">
                    ...
                    <select class="form-control" name="sumber_id" id="sumber">
                        ...
                        <option value="{{ $opt->id }}" @if($biodata->sumber_id==$opt->id) @selected(true) @else @selected(false) @endif>{{ ucfirst($opt->nama) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col p-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control calculate" name="tmt_sumber" id="mdate_sumber" value="@isset ($biodata->tmt_sumber){{ Carbon\Carbon::createFromFormat('Y-m-d', $biodata->tmt_sumber)->format(format:'d-m-Y') }} @endisset">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <span class="mdi mdi-calendar"></span>
                            </span>
            ...
            <div class="form-group d-flex m-0">
                <div class="col-8 p-2">
                    ...
                    <select class="form-control" name="kategori_id" id="kategori">
                        <option></option>
                        @foreach (App\Models\Sumber::all() as $opt)
                        <option value="{{ $opt->id }}" @if($biodata->kategori_id==$opt->id) @selected(true) @else @selected(false) @endif>{{ ucfirst($opt->nama) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col p-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control calculate" name="tmt_kategori" id="mdate_pensiun" value="@isset ($biodata->tmt_kategori){{ Carbon\Carbon::createFromFormat('Y-m-d', $biodata->tmt_kategori)->format(format:'d-m-Y') }} @endisset">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <span class="mdi mdi-calendar"></span>
                            </span>
            ...
            <div class="form-group d-flex m-0">
                ...
                <div class="col p-2">
                    ...
                    <input type="text" class="form-control" name="gaji_terakhir" id="gaji_terakhir" value="{{ $biodata->getVal($biodata->gaji_terakhir) }}">
                </div>
                
                <div class="col-4 p-2">
                    <label>Masa Kerja</label>
                    <div class="input-group no-wrap">
                        <input type="text" class="form-control readonly text-right" name="tahun_masa_kerja" id="tahun_masa_kerja" value="{{ $biodata->getMasa($biodata->tahun_masa_kerja) }}" @readonly(true)>
                        <div class="input-group-append">
                            <span class="input-group-text p-1"><sup>Th</sup></span>
                        </div>
                        <input type="text" class="form-control readonly text-right" name="bulan_masa_kerja" id="bulan_masa_kerja" value="{{ $biodata->getMasa($biodata->bulan_masa_kerja) }}" @readonly(true)>
                        <div class="input-group-append">
                ...
                <div class="col p-2">
                    ...
                    <input type="text" class="form-control" name="gaji_pensiun" id="gaji_pensiun" value="{{ $biodata->getVal($biodata->gaji_pensiun) }}">
                </div></div>

            <div class="form-group p-2 m-0">
                <label><i class="mdi mdi-file-pdf"></i><code>.pdf </code> Pangkat Terakhir</label><br>@if($biodata->pangkat_file) <a href="{{ asset('storage/'.$biodata->pangkat_file) }}" target="_blank">{{ $biodata->pangkat_file }} </a> @else - @endif
            ...
            <div class="form-group p-2 m-0">
                <label><i class="mdi mdi-file-pdf"></i><code>.pdf </code> Sumber Pangkat</label><br>@if($biodata->sumber_file) <a href="{{ asset('storage/'.$biodata->sumber_file) }}" target="_blank">{{ $biodata->sumber_file }} </a> @else - @endif
                <div class="fileinput fileinput-new input-group bg-dark" data-provides="fileinput">
                    <div class="form-control" data-trigger="fileinput"> <i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div> <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new text-light">Select file</span> <span class="fileinput-exists text-info">Change</span>
            ...
            <div class="form-group p-2 m-0">
                <label><i class="mdi mdi-file-pdf"></i><code>.pdf </code> KTA</label><br>@if($biodata->kta_file) <a href="{{ asset('storage/'.$biodata->kta_file) }}" target="_blank">{{ $biodata->kta_file }} </a> @else - @endif
                <div class="fileinput fileinput-new input-group bg-dark" data-provides="fileinput">
                ...
                <div class="col-3 m-0 p-0">
                    ...
                    <div class="fileinput-new img-responsive" style="width:100px; max-width:100px; max-height:150px; height:auto;">
                        ...
                        @if($biodata->foto_file) <img src="{{ url('storage/'.$biodata->foto_file) }}" alt="" style="width:100px; max-width:100px; max-height:150px; height:auto;">  @else <img src="{{ url('storage/image_holder.png') }}" alt=""> @endif
                    </div>
                </div>
...
<div class="col-md-12 mb-4">
    <div class="action-form">
        <div class="form-group mb-0 text-center">
            <button type="submit" class="btn btn-success waves-effect waves-light mdi mdi-content-save-all px-4 mx-2"> P A T C H</button>
            <a href="{{ url()->previous() }}" type="reset" class="btn btn-dark waves-effect waves-light mdi mdi-backburger px-3 mx-2" role="button"> BACK</a>
        </div>
    </div>
</div>
